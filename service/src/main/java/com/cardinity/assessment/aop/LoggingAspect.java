package com.cardinity.assessment.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.cardinity.assessment.service..*(..))")
    public void serviceLoggingPointcut() {
        /** Matches all the public methods of Services */
    }

    @Pointcut("@within(com.cardinity.assessment.annotation.EnableLogging)")
